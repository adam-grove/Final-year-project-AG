...
# Reading in data
```{R}
my_data <- read.csv("C:/Users/adamg/OneDrive - The University of Liverpool/Project Work/DIMSpy/Runs/DIMSpy_SNR3.5_ppm555_NC_Feature_Matrix.csv")
...
write.csv(pca_data,"DIMSpy_SNR3.5_ppm555_NC_BC_Feature_Matrix.csv")
